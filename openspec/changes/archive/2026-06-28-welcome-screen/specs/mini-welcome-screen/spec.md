...
- **WHEN** the welcome screen renders
- **THEN** PrimaryButton displays full-width black button with spaced label text

#### Scenario: CTA navigates to contract create

- **WHEN** user taps the "开始立约" button
- **THEN** the app navigates to the contract-create placeholder page
